...
export const TURN_EVENT_LABELS: Record<TurnEventId, string> = {
  ...
  prince_took_capital: '藩王が都を陥とし、帝位に即いた',
  faction_proclaimed: '胡族の首長が帝を称した',
  city_fell: '城が陥ちた',
  usurpation: '簒奪',
  abdication: '禅譲 — 位が渡り、王朝が替わった',
  succession_crisis: '継承危機',
  officer_left: '仕えていた者が去った',
  officer_defected: '兵を預けた者が離れた',
  officer_recruited: '在野の者を登用した',
  corps_dispatched: '軍を発した',
  corps_took_city: '城を陥とし、州を取り返した',
  corps_broken: '出征軍が崩れた',
